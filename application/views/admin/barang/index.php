<div class="container-fluid">
    <div class="row">
        <div class="col-md-7 col-md-offset-2">
            <a href="<?=site_url('admin/barang/add')?>"><input type="submit" class="btn btn-md btn-primary" name="Tambah Barang" value="Tambah Barang"></a></br>
        </div>
    </div>
</div>
<br>
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        ?>
                            ...
                            <td>
                                <a href="<?= site_url('admin/barang/edit') ?>?id=<?php echo $data['id_barang'] ?>">
                            ...
                            <td>
                                <a href="<?= site_url('admin/barang/delete') ?>?id=<?php echo $data["id_barang"]; ?>">
