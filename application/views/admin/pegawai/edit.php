<div class="container-fluid">
    <div class="col-md-7 col-md-offset-2">
        <form class="form-horizontal" method="post" action="<?=site_url('admin/pegawai/edit')?>?id=<?=$_GET['id']?>">
            <?php
            ...
            ?>
                    ...
                    <div class="form-group">
                        <div class="col-md-7 col-md-offset-2">
                        	...
                        	<a class="btn btn-danger" href="<?=site_url('admin/pegawai/')?>" role="button">Batal</a>
