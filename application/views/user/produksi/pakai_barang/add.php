<div class="container-fluid">
    <div class="col-md-7 col-md-offset-2">
        <form class="form-horizontal" method="post" action="<?= site_url('produksi/pakai_barang/add') ?>">
            <?php
            ...
            ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input type="text" disabled class="form-control" id="nama_barang" value="<?php echo $value['nama_barang']; ?>">
                            <input type="hidden" disabled class="form-control" id="id_barang" name="id_barang" value="<?php echo $value['id_barang']; ?>">
                        </div>
                    </div>
                    <br>
                    <div class="form-group">
